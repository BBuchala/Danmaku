...
class TrajectoryFactory
{
	...
	typedef TrajectorySimple * (*CreateTrajectoryCallback)( D3DXVECTOR2 const & startPoint, float const a, float const b);
...
public:
	...
	TrajectorySimple * const CreateTrajectory( Road const trajecory, D3DXVECTOR2 const & position, float const a = 0.0f, float const b = 0.0f );
